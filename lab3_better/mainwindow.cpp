...
void MainWindow::render()
{
    ...
    auto drawer = director.get_drawer("C:/msys64/home/alena/oop_lab32/config.cfg", factory);
...
std::string MainWindow::readConfigFileDrawer(const char *filename)
{
    std::ifstream file_;
    time_t t_time = time(NULL);
...
{
    MainWindow obj;
    if (obj.readConfigFileDrawer(fp) == "Qt")
    {
